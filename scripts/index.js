...
const createCard = (data) => {
  ...
  /** Обработчик лайк */
  cardElement.querySelector('.elements__item-like').addEventListener('click', evt => activeLike(evt));
...
/** Открыть форму PopUp */
const  popupOpen = (popupWindowOpen) => {
  popupWindowOpen.classList.add('popup_opened');
  document.addEventListener('keydown', closePopupEsc);
};
/** Закрыть форму PopUp */
const popupClose = (popupWindowClose) => {
